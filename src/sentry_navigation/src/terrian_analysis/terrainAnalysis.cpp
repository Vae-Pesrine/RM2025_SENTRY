...
int main(int argc, char **argv) {
  ...
  // nhPrivate.getParam("terrian_analysis/scanVoxelSize", scanVoxelSize);
  // nhPrivate.getParam("terrian_analysis/decayTime", decayTime);
  // nhPrivate.getParam("terrian_analysis/noDecayDis", noDecayDis);
  // nhPrivate.getParam("terrian_analysis/clearingDis", clearingDis);
  // nhPrivate.getParam("terrian_analysis/useSorting", useSorting);
  // nhPrivate.getParam("terrian_analysis/quantileZ", quantileZ);
  // nhPrivate.getParam("terrian_analysis/considerDrop", considerDrop);
  // nhPrivate.getParam("terrian_analysis/limitGroundLift", limitGroundLift);
  // nhPrivate.getParam("terrian_analysis/maxGroundLift", maxGroundLift);
  // nhPrivate.getParam("terrian_analysis/clearDyObs", clearDyObs);
  // nhPrivate.getParam("terrian_analysis/minDyObsDis", minDyObsDis);
  // nhPrivate.getParam("terrian_analysis/minDyObsAngle", minDyObsAngle);
  // nhPrivate.getParam("terrian_analysis/minDyObsRelZ", minDyObsRelZ);
  // nhPrivate.getParam("terrian_analysis/absDyObsRelZThre", absDyObsRelZThre);
  // nhPrivate.getParam("terrian_analysis/minDyObsVFOV", minDyObsVFOV);
  // nhPrivate.getParam("terrian_analysis/maxDyObsVFOV", maxDyObsVFOV);
  // nhPrivate.getParam("terrian_analysis/minDyObsPointNum", minDyObsPointNum);
  // nhPrivate.getParam("terrian_analysis/noDataObstacle", noDataObstacle);
  // nhPrivate.getParam("terrian_analysis/noDataBlockSkipNum", noDataBlockSkipNum);
  // nhPrivate.getParam("terrian_analysis/minBlockPointNum", minBlockPointNum);
  // nhPrivate.getParam("terrian_analysis/vehicleHeight", vehicleHeight);
  // nhPrivate.getParam("terrian_analysis/voxelPointUpdateThre", voxelPointUpdateThre);
  // nhPrivate.getParam("terrian_analysis/voxelTimeUpdateThre", voxelTimeUpdateThre);
  // nhPrivate.getParam("terrian_analysis/minRelZ", minRelZ);
  // nhPrivate.getParam("terrian_analysis/maxRelZ", maxRelZ);
  // nhPrivate.getParam("terrian_analysis/disRatioZ", disRatioZ);
