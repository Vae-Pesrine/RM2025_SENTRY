#ifndef TERRIAN_ANALYSIS_HPP_
#define TERRIAN_ANALYSIS_HPP_
...
private:
    ...
    void pointCloudCallback(const sensor_msgs::PointCloud2::ConstPtr& pointcloud2);
...
private:
    ...
    ros::Publisher pub_terrian_map_;
