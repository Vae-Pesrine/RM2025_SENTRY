...
class Bernstein
{
	private:
		...
		std::vector<Eigen::MatrixXd> MQMList, MList;
		std::vector<Eigen::MatrixXd> FMList;
	...
	public:
		...
		std::vector<MatrixXd> getM(){ return MList; }
		std::vector<MatrixXd> getMQM(){ return MQMList; }
		std::vector<MatrixXd> getFM(){ return FMList; }
		std::vector<VectorXd> getC(){ return CList; }
		std::vector<VectorXd> getC_v(){ return CvList; }
		std::vector<VectorXd> getC_a(){ return CaList; }
		std::vector<VectorXd> getC_j(){ return CjList; }
};
