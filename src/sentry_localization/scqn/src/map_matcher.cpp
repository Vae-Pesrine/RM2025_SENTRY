...
int MapMatcher::fetchClosestKeyframeIdx(const PosePcdStamped &front_keyframe,
...
PcdPair MapMatcher::setSrcAndDstCloud(const PosePcdStamped &query_keyframe,
...
RegistrationOutput MapMatcher::performMapMatcher(const PosePcdStamped &query_keyframe,
                                                 const std::vector<PosePcdReduced> &saved_keyframes,
